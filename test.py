...
# Funkcja do dodawania kodu kreskowego na górze rysunku na tej samej stronie PDF
def dodaj_kod_do_pdf(plik_pdf, plik_png, sciezka_docelowa):
    ...
    for page_num, page in enumerate(pdf_reader.pages):
        ...
        # Tworzymy nowe płótno do rysowania kodu kreskowego w górnej części strony
        packet = io.BytesIO()
        can = canvas.Canvas(packet, pagesize=(page_width, dodatkowy_obszar_roboczy))

        # Pozycjonowanie kodu kreskowego w punkcie (0,0)
        x_position = 0  # Lewa krawędź
        y_position = page_height - barcode_img_height  # Dolna krawędź (czyli punkt 0,0)
