...
def dodaj_kod_do_pdf(plik_pdf, plik_png, sciezka_docelowa):
    ...
    for page_num, page in enumerate(pdf_reader.pages):
        ...
        # Obliczanie pozycji dla kodu kreskowego (środek na dole strony)
        x_position = (letter[0] - barcode_img_width) / 2  # Szerokość strony minus szerokość obrazka, na środku
        y_position = 10 * mm  # 10 mm od dolnej krawędzi

        # Rysowanie obrazu kodu kreskowego
