...
def dodaj_kod_do_pdf(plik_pdf, plik_png, sciezka_docelowa):
    ...
    for page_num, page in enumerate(pdf_reader.pages):
        ...
        x_position = 0  # Na środku strony
        y_position = 0 # 10 mm od dolnej krawędzi strony
...
katalog_docelowy = 'rysunki_z_kodami_DOLNE'  # Katalog do zapisania nowych plików PDF
